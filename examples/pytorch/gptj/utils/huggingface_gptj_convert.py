...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model-dir", help="File of GPT-J huggingface checkpoint", default="EleutherAI/gpt-j-6b"
    )
    parser.add_argument(
    ...
    model = AutoModelForCausalLM.from_pretrained(args.model_dir, low_cpu_mem_usage=True)
