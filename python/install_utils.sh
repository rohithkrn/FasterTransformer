...
mkdir -p fastertransformer/examples/{t5,gptneox,gpt,gptj}
echo "" > fastertransformer/examples/t5/__init__.py
echo "" > fastertransformer/examples/gptneox/__init__.py
echo "" > fastertransformer/examples/gptj/__init__.py
...
cp ../examples/pytorch/gptj/utils/huggingface_gptj_convert.py fastertransformer/examples/gptj/
cp ../examples/pytorch/gpt/utils/{gpt_token_encoder.py,gpt.py,parallel_gpt.py,huggingface_gpt_convert.py,huggingface_opt_convert.py} fastertransformer/examples/gpt/
